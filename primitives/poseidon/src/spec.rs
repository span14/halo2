...
impl<F: PrimeField + FromUniformBytes<64>, const T: usize, const RATE: usize> Spec<F, T, RATE> {
...
pub(super) mod tests {
    ...
    impl<F: PrimeField + FromUniformBytes<64>, const T: usize, const RATE: usize> SpecRef<F, T, RATE> {
